...
export const COMMON_DIAGNOSES = [
  {
    ...
    category: DiagnosisCategory.INFECTIOUS,
  },
  {
    icd10Code: 'A15',
  ...
  },
  {
    ...
    category: DiagnosisCategory.CIRCULATORY,
    isChronic: true,
  },
  {
    icd10Code: 'J00',
  ...
  {
    icd10Code: 'K52',
    name: 'Non-infective gastroenteritis and colitis',
    category: DiagnosisCategory.DIGESTIVE,
  },
  {
    icd10Code: 'L02',
    name: 'Cutaneous abscess, furuncle and carbuncle',
    category: DiagnosisCategory.SKIN,
  },
  ...
  {
    icd10Code: 'O82',
    name: 'Delivery by caesarean section',
    category: DiagnosisCategory.PREGNANCY,
  },
  ...
  {
    icd10Code: 'T14',
    name: 'Injury of unspecified body region',
    category: DiagnosisCategory.INJURY,
  },
