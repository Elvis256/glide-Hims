...
const defaultPermissions = [
  ...
  // Allergies (FHIR AllergyIntolerance — clinical-staff only)
  { code: 'allergies.write', name: 'Record/Edit Patient Allergies', module: 'patients' },
  { code: 'allergies.delete', name: 'Hard-delete Allergy Records', module: 'patients' },
  ...
  { code: 'assets.reports.read', name: 'View Asset Reports', module: 'assets' },
...
export async function seed(dataSource: DataSource) {
  ...
  const rolePermissionMappings: Record<string, string[]> = {
    ...
    'Facility Manager': [
      ...
      'assets.maintenance.record',
      'assets.transfer.initiate',
      'assets.transfer.complete',
      'assets.transfer.approve',
      'assets.allocation.approve',
      'assets.allocation.issue',
      'assets.allocation.return',
