...
const samplePatients = [
  ...
  },
  {
    ...
    phone: '+256706789012',
    nationalId: 'CF88092589012F',
  },
  {
    mrn: 'MRN00007',
    fullName: 'James Ssempala',
    gender: 'male',
    dateOfBirth: '1975-04-18',
    phone: '+256707890123',
    nationalId: 'CM75041890123G',
  },
  {
    mrn: 'MRN00008',
    fullName: 'Agnes Namutebi',
    gender: 'female',
    dateOfBirth: '2000-12-05',
    phone: '+256708901234',
    nationalId: 'CF00120501234H',
  },
  {
    mrn: 'MRN00009',
    fullName: 'Robert Okello',
    gender: 'male',
    dateOfBirth: '1992-08-20',
    phone: '+256709012345',
    nationalId: 'CM92082012345I',
  },
  {
    mrn: 'MRN00010',
    fullName: 'Florence Atim',
    gender: 'female',
    dateOfBirth: '1987-02-14',
    phone: '+256710123456',
    nationalId: 'CF87021423456J',
  },
];
...
export async function seedClinicalData(dataSource: DataSource) {
  ...
  for (const item of items) {
    ...
    if (!existingBalance) {
      ...
      const initialQty = item.isDrug
        ? Math.floor(Math.random() * 150) + 50
        : Math.floor(Math.random() * 30) + 20;

      // Create stock ledger entry
      const ledger = await stockLedgerRepo.save(
