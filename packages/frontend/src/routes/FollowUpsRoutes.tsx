...
/**
 * Follow-up screens at /follow-ups/*, which is where the sidebar links.
 *
 * They remain mounted under /doctor/follow-ups/* as well: other pages link
 * there directly, so both paths answer.
 */
export default function FollowUpsRoutes() {
  return (
    <Routes>
      <Route path="new" element={<ModuleRoute module="doctors"><DoctorRoute><ScheduleFollowUpPage /></DoctorRoute></ModuleRoute>} />
      <Route path="" element={<ModuleRoute module="doctors"><DoctorRoute><FollowUpsPage /></DoctorRoute></ModuleRoute>} />
      <Route path="overdue" element={<ModuleRoute module="doctors"><DoctorRoute><OverdueFollowUpsPage /></DoctorRoute></ModuleRoute>} />
    </Routes>
  );
}
