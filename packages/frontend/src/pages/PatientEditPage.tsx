  ...
  useEffect(() => {
    if (patient) {
      ...
      const initialData: FormData = {
        ...
        occupation: patient.occupation || (metadata.occupation as string) || '',
        bloodGroup: patient.bloodGroup || '',
        allergies: (Array.isArray(patient.allergies) ? patient.allergies.join(', ') : (metadata.allergies as string)) || '',
