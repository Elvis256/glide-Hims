...
const navigationSections: NavSection[] = [
  // 1. Registration - Reception/Front Desk (Everything done at reception)
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          { name: 'New Bill', href: '/billing/opd/new', icon: Receipt, permissions: ['billing.create'] },
          ...
          { name: 'Collect Payment', href: '/cashier', icon: Banknote, permissions: ['billing.create'] },
          { name: 'Print Receipt', href: '/billing/payments', icon: Printer, permissions: ['billing.read'] },
          { name: 'Pending Payments', href: '/billing/invoices', icon: Clock, permissions: ['billing.read'] },
      ...
      },
      {
        ...
        children: [
          ...
          { name: 'Claim Submission', href: '/billing/insurance/claims', icon: FileText, permissions: ['insurance.create'] },
      ...
      },
      {
        ...
        children: [
          { name: 'Daily Summary', href: '/reports/daily', icon: FileText, permissions: ['reports.read'] },
          { name: 'Patient Statistics', href: '/reports/patients', icon: Users, permissions: ['reports.read'] },
          { name: 'Revenue Report', href: '/reports/revenue', icon: DollarSign, permissions: ['reports.read', 'billing.read'] },
          { name: 'Queue Performance', href: '/reports/queue', icon: Activity, permissions: ['reports.read'] },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { name: 'Sample Referrals', href: '/lab/sample-referrals', icon: GitBranch, permissions: ['lab.read'] },
        ],
      },
      {
  ...
  // 6. Pharmacy
  {
    ...
    items: [
      { name: 'Pharmacy Dashboard', href: '/pharmacy/dashboard', icon: LayoutDashboard, permissions: ['pharmacy.read'] },
      ...
      },
      {
        ...
        href: '/procurement/requisitions?category=drugs',
        icon: Truck,
        permissions: ['procurement.read'],
      },
      {
        name: 'Vendors',
        href: '/procurement/vendors?category=drugs',
        icon: Building,
      ...
      { name: 'Transfers', href: '/pharmacy/transfers', icon: ArrowRightLeft, permissions: ['pharmacy.inventory'] },
      {
        name: 'Clinical Tools',
        icon: Stethoscope,
        permissions: ['pharmacy.read', 'pharmacy.controlled'],
        children: [
          { name: 'Controlled Register', href: '/pharmacy/controlled-register', icon: Lock, permissions: ['pharmacy.controlled'] },
          { name: 'Medication Adherence', href: '/pharmacy/adherence', icon: Activity, permissions: ['pharmacy.read'] },
          { name: 'Prescription Templates', href: '/pharmacy/rx-templates', icon: FileText, permissions: ['pharmacy.read'] },
          { name: 'Label Management', href: '/pharmacy/labels', icon: Languages, permissions: ['pharmacy.read'] },
        ],
      },
      {
        name: 'Quality & Safety',
        ...
        children: [
          { name: 'Temperature Monitoring', href: '/pharmacy/temperature', icon: Thermometer, permissions: ['pharmacy.read'] },
          { name: 'DUR Reports', href: '/pharmacy/dur-reports', icon: BarChart3, permissions: ['pharmacy.read'] },
          { name: 'Drug Database Sync', href: '/pharmacy/drug-db-sync', icon: Database, permissions: ['pharmacy.read'] },
          { name: 'Notification Log', href: '/pharmacy/notifications', icon: Bell, permissions: ['pharmacy.read'] },
        ],
      },
  ...
  // 7. IPD - Inpatient
  {
    ...
    items: [
      ...
      { name: 'Theatre', href: '/ipd/theatre', icon: Scissors, permissions: ['surgery.read', 'surgery.create'] },
      { name: 'Maternity', href: '/ipd/maternity', icon: Baby, permissions: ['maternity.read', 'maternity.create'] },
      { name: 'Discharge', href: '/ipd/discharge', icon: ClipboardCheck, permissions: ['ipd.update'] },
    ...
    items: [
      ...
      { name: 'Payments', href: '/billing/payments', icon: Banknote, permissions: ['billing.read'] },
      {
        ...
        children: [
          ...
          { name: 'Claims', href: '/billing/insurance/claims', icon: FileText, permissions: ['insurance.read'] },
          { name: 'Pre-auth', href: '/insurance/preauth', icon: FileCheck, permissions: ['insurance.create'] },
          { name: 'Providers', href: '/billing/insurance/providers', icon: Building, permissions: ['insurance.read'] },
          { name: 'Insurance Cards', href: '/insurance/cards', icon: CreditCard, permissions: ['insurance.read'] },
  ...
  // 8b. Finance (own top-level module — back-office accounting)
  {
    title: 'Finance',
    icon: Calculator,
    moduleCode: 'finance',
    ...
    items: [
      ...
      { name: 'Cost Centers', href: '/finance/cost-centers', icon: Layers, permissions: ['finance.read'] },
      { name: 'Budgets', href: '/finance/budgets', icon: ClipboardCheck, permissions: ['finance.read', 'finance.create'] },
      { name: 'Bank Reconciliation', href: '/finance/bank-reconciliation', icon: Landmark, permissions: ['finance.read', 'finance.create'] },
      { name: 'Patient Finance', href: '/finance/patient-finance', icon: Wallet, permissions: ['finance.read'] },
      { name: 'Petty Cash', href: '/finance/petty-cash', icon: Coins, permissions: ['finance.read', 'finance.create'] },
      { name: 'Donor Funds', href: '/finance/donor-funds', icon: Gift, permissions: ['finance.read'] },
    ],
  },
  // 9. Stores / Inventory
  {
    ...
    items: [
      ...
      { name: 'Stock Transfers', href: '/inventory/transfers', icon: ArrowDownUp, permissions: ['stores.update'] },
      {
        ...
        href: '/procurement/requisitions?category=supplies',
        icon: Truck,
        permissions: ['procurement.read'],
      },
      {
        name: 'Vendors',
        href: '/procurement/vendors?category=supplies',
        icon: Building,
        permissions: ['suppliers.read'],
      },
      {
    ...
    items: [
      ...
      { name: 'Analytics', href: '/analytics', icon: BarChart3, permissions: ['analytics.read'] },
      {
        ...
        children: [
          ...
          { name: 'HMIS 105', href: '/reports/hmis-105', icon: ClipboardList, permissions: ['reports.read'] },
        ],
      },
      {
  ...
  // 11. HR
  {
    ...
    items: [
      ...
      { name: 'Payroll Reports', href: '/hr/payroll-reports', icon: DollarSign, permissions: ['payroll.read'] },
